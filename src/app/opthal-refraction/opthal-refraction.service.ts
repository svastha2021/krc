...
export class OpthalRefractionService {

    constructor(private route: Router, private http: HttpClient) { }

    createBasic(params: any): Observable<any> {
    ...
    getRefraction(orgId: any, branchId: any, patientId: any, paramType: any): Observable<any> {
        let headers = new HttpHeaders();
        headers.append('Content-Type', 'application/json');
